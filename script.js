...
//   emailjs
//     .send("service_6ckudp3", "template_6t62b91", params)
//     .then(function (res) {
//       alert("Mail sent successfully! Status: " + res.status);
//     })
...
// // Animate the .hero-main element
// tl.from('.hero-main', {
//   scale: 0,
//   opacity: 0,
//   yPercent: -100,
//   duration: 0.6,
//   ease: 'power2.out' // Optional: You can use an easing function for smooth transitions
// })
//   .from('.hero-main-text-area', {
//     xPercent: -200,
//     duration: 0.6,
//     ease: 'power2.out'
//   })
